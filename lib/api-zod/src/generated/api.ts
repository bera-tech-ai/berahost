...
export const ListBotsResponseItem = zod.object({
  ...
  "requiredVars": zod.object({

}).passthrough().nullish(),
  "optionalVars": zod.object({
...
export const AdminListDeploymentsResponse = zod.array(AdminListDeploymentsResponseItem)
...
export const AdminListVouchersResponse = zod.array(AdminListVouchersResponseItem)
